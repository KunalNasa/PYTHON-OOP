...
class Library:
    ...
    def lendbook(self):
        ...
        if lending in self.List_of_books:
            ...
            print(
                "Sorry to tell you that this Book is either not available in our Library or It has been issued by someone's else."
...
Kunal = Library(["Hindi","English","Maths"],"Kunal's Library")
